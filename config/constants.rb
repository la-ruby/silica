...
#
{
  ...
  'APOLLO_PURCHASER_EMAIL' => "purchaser@exmple.com",
  'APOLLO_NAME' => "Acme",
  'APOLLO_NAKED_DOMAIN' => 'example.com',
  'APOLLO_BACKEND_DOM' => 'backend.example.com',
  'APOLLO_MBO_DOM' => 'example.net',
  'APOLLO_MBO_NAKED_DOM' => 'example.net',
  'APOLLO_MARKETPLACE_DOM' => 'example.org',
  'APOLLO_MARKETPLACE_NAKED_DOM' => 'example.org',
  ...
  'APOLLO_ADMIN_LOGIN' => 'testing.developer.1@example.com',
  'APOLLO_CDN' => 'http://localhost:4000',
  'APOLLO_GOOGLE_MAPS_API_KEY' => 'testing',
  'COMPANY_UC' => 'ACME',
  'COMPANY_LC' => 'acme',
  'COMPANY' => 'Acme',
  'LIMITED_USER1' => 'limited1@example.com',
  'LIMITED_USER2' => 'limited2@example.com',
