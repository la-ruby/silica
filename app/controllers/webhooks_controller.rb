...
class WebhooksController < ApplicationController
  ...
  def webhook_revert
    ...
    if Rails.env.production? && !APOLLO_INTERNAL_PRODUCTION
      `heroku pg:copy silica-#{APOLLO_HEROKU_APP}::DATABASE_URL DATABASE_URL -a silica-internal-#{APOLLO_HEROKU_APP} --confirm silica-internal-#{APOLLO_HEROKU_APP}`
    end
