class RepcsController < ApplicationController
  ...
  before_action :set_repc, only: %i[update]

  # this used to be myoffers#crayon
  def show
    ...
    authorize nil, policy_class: RepcPolicy
  ...
  def save
    ...
    [
      turbo_stream.replace('prepare-repc-panel', partial: '/projects/show/underwriting_prepare_repc/underwriting_prepare_repc', locals: { project_id: @repc.project_id}),
